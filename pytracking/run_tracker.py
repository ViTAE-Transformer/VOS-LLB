...
def main():
    ...
    parser.add_argument('tracker_name', type=str, help='Name of tracking method.')   # joint
    parser.add_argument('tracker_param', type=str, help='Name of parameter file.')   #joint_davis
