...
class ViTAEv2(nn.Module):
    ...
    def __init__(self,
        ...
        self._out_feature_channels = { 'layer1': token_dims[0], 'layer2': token_dims[1],
                                    'layer3': token_dims[2], 'layer4': token_dims[3]}

        self.output_names = ['layer1', 'layer2', 'layer3', 'layer4']
    ...
    def forward(self, x, output_layers=None):
        ...
        for key, value in zip(self.output_names, outs):
            outputs[key] = value
